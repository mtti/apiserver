...
/**
 * Returns a regular Express request handler when given
 * a `WrappedRequestHandler`. Catches any errors thrown by the wrapped handler
 * and forwards them to the Express error handler.
 */
